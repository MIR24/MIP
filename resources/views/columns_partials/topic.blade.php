<div class="col-md-4">
    <div class="cellwrap">
        ...
        <div id="showTopics{{ $topic['id'] }}" class="meta" data-name="{{$topic['name']}}" data-short="{{$topic['description_short']}}" data-full="{{$topic['description_long']}}" data-link="http://downloads.mip.news/{{$topic['ftp_url']}}"></div>
    </div>
</div>